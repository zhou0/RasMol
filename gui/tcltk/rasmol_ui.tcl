...
.menubar.settings add radiobutton -label "Rotate Bond" -variable rot_mode -value 1 -command {send_rasmol_menu 4 11}
.menubar.settings add radiobutton -label "Rotate Molecule" -variable rot_mode -value 2 -command {send_rasmol_menu 4 12}
.menubar.settings add radiobutton -label "Rotate All" -variable rot_mode -value 4 -command {send_rasmol_menu 4 13}
...
proc rotate_molecule {axis args} {
    ...
    # rot_mode: 1=Bond, 2=Molecule, 4=All
    if {$rot_mode == 11} {
        if {$axis eq "h"} {
...
proc update_status {} {
    if {[info commands rasmol_info] ne ""} {
        ...
        set rot_mode [rasmol_info rotmode]
